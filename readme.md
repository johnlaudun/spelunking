...
What I propose to do is to devise a collection of prompts designed to elicit such long n-grams as would include the possibility of proverbs and then take those results and certify them by searching for them in actual use in those texts available on the public web -- some LLMs have been trained on closed sources (e.g., JSTOR) where such searches would be impossible. 
